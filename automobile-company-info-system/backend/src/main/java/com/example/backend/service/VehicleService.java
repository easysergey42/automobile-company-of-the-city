...
public class VehicleService {
    ...
    @Transactional
    public VehicleDTO create(@NonNull VehicleFrontDTO request){
...
//            newGE.setVehicles(List.of(vehicle));
    ...
    @Transactional
    public VehicleDTO update(@NonNull VehicleFrontDTO request){
    ...
    public List<String> sendFields(){
        return Arrays.stream(VehicleFrontDTO.class.getDeclaredFields()).map(Field::getName).collect(Collectors.toList());
    }
}
